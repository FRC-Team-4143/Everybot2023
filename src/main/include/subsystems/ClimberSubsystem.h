...
public:
	...
	ClimberSubsystem(frc::XboxController* controller, wpi::log::DataLog& log);
...
// ==============================================================================================================
	...
	wpi::log::DoubleLogEntry m_rotateLeftCurrent;
	wpi::log::DoubleLogEntry m_rotateRightCurrent;
	wpi::log::DoubleLogEntry m_extendLeftCurrent;
	wpi::log::DoubleLogEntry m_extendRightCurrent;
	wpi::log::DoubleLogEntry m_rotateLeftVelocity;
	wpi::log::DoubleLogEntry m_rotateRightVelocity;
	wpi::log::DoubleLogEntry m_extendLeftVelocity;
	wpi::log::DoubleLogEntry m_extendRightVelocity;
